...
CREATE SCHEMA IF NOT EXISTS `fanta_formazione` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci ;
...
CREATE  TABLE IF NOT EXISTS `fanta_formazione`.`formazioni` (
  ...
  `prob_titolare` INT NOT NULL DEFAULT 0 ,
  `prob_panchina` INT NOT NULL DEFAULT 0 ,
...
CREATE  TABLE IF NOT EXISTS `fanta_formazione`.`probabili_formazioni_fg` (
  ...
  `titolare` TINYINT(1)  NULL ,
  `panchina` TINYINT(1)  NULL ,
